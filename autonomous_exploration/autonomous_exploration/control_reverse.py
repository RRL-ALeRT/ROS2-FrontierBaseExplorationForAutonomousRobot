...
speed = 0.6 # The maximum speed of the robot (in meters per second).
expansion_size = 4 # The factor by which obstacles are expanded during path planning.
...
class navigationControl(Node):
    def __init__(self):
        ...
        # self.subscription = self.create_subscription(OccupancyGrid,'/projected_map_1m',self.map_callback,1)
